...
stripe.api_key='sk_test_51Kk1QqSC5AJpm0bkbnDz568QF0FrPsudpDJRtVRszNmqeRyLShM8VF6Q9dTn1GC2Z4YFOW8QkjMj70nxgtZqRSTK00jbew3ELi'
...
def pay_success(request):
	...
	from_email='pragyasam711@gmail.com'
...
def user_dashboard(request):
	...
	my_trainer=models.AssignSubscriber.objects.get(subscriber=request.user)
